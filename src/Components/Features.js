    ...
    <main className="">
      <div className="flex flex-col items-center space-y-5">
        <div className="text-center">
          <div className="text-[#6840c6] text-lg md:text-base font-semibold font-['Inter'] leading-normal">
            Features
          </div>
          <div className="text-[#0f1728] text-3xl md:text-4xl font-semibold font-['Inter'] leading-10 pt-4">
            Analytics that feels like it’s from the future
          </div>
        </div>
        <div className="text-center text-[#475466] text-lg md:text-xl font-normal font-['Inter'] md:leading-loose max-w-3xl">
