...
const Footer = () => {
  return (
    <main className="px-1 md:px-24 mx-auto mb-5">
      <footer>
        <div className="max-w-full p-4 grid grid-cols-2  md:grid-cols-6 justify-between gap-8">
          {[
            {
              title: "Product",
              items: [
            ...
            <div key={section.title} className="flex-1 ">
              <div className="text-[#667084] text-sm font-semibold leading-tight mb-2">
                {section.title}
              </div>
              <div className="flex flex-col gap-2">
                {section.items.map((item, index) => (
                  <div key={index} className="flex items-center">
                    <span className="text-[#475466] text-base font-semibold leading-normal">
                      {item}
                    </span>
                    {section.newItem && item === "Solutions" && (
                      <span className="ml-2 px-2 py-0.5 bg-[#ebfdf2] rounded-2xl border border-[#abefc6] text-[#067647] text-xs font-medium">
                        {section.newItem}
                      </span>
                    )}
                  </div>
        ...
        <div className="border-b-[1px] pt-5"></div>
        <div className="flex flex-col md:flex-row justify-between md:items-center mt-5 md:mt-10 px-4">
          <div>
            <svg
              width="145"
              height="38"
            ...
            >
              <g filter="url(#filter0_dd_633_3828)">
                <g clip-path="url(#clip0_633_3828)">
                  <rect
                    x="3"
                    y="2"
                    width="32"
                  ...
                  <rect
                    ...
                    height="32"
                    rx="8"
                    fill="url(#paint0_linear_633_3828)"
                  />
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                  ...
                  <path
                    ...
                    fill="#D0D5DD"
                  />
                  <g filter="url(#filter1_dd_633_3828)">
                    <circle
                      cx="19"
                      cy="18"
                      r="8"
                      fill="url(#paint1_linear_633_3828)"
                    />
                  </g>
                  <g filter="url(#filter2_b_633_3828)">
                    <path
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    ...
                    result="effect1_dropShadow_633_3828"
                  />
                  <feColorMatrix
                    in="SourceAlpha"
                    type="matrix"
                  ...
                  <feBlend
                    mode="normal"
                    in2="effect1_dropShadow_633_3828"
                    result="effect2_dropShadow_633_3828"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect2_dropShadow_633_3828"
                    result="shape"
                  />
                </filter>
                <filter
                  id="filter1_dd_633_3828"
                  x="8"
                  y="8"
                  width="22"
                  height="22"
                ...
                >
                  ...
                  <feComposite
                    in2="SourceAlpha"
                    operator="in"
                    result="effect1_backgroundBlur_633_3828"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_backgroundBlur_633_3828"
                    result="shape"
                  />
                </filter>
                <linearGradient
                  id="paint0_linear_633_3828"
                  x1="19"
                  y1="2"
                  x2="19"
                  y2="34"
          ...
          <p className="w-fit text-[#667084] text-base font-normal font-['Inter'] leading-normal max-md:pt-2">
